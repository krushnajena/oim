        ...
        children: [
          ...
          GridView.builder(
            ...
            itemBuilder: (BuildContext context, int index) {
              return InkWell(
                onTap: () {
                  print(popularStores[index]["storeid"]["businesscatagories"]);
                  popularStores[index]["storeid"]["businesscatagories"] ==
                          "Restaurant"
                      ? Navigator.push(
                          context,
                          MaterialPageRoute(
                              builder: (context) => ResturentDetailsScreen(
                        ...
                        SizedBox(
                          ...
                          child: Card(
                            ...
                            child: InkWell(
                              ...
                              child: Image.network(
                                baseUrl +
                                    popularStores[index]["storeid"]["photo"],
                                fit: BoxFit.cover,
                              ),
                            ),
                          ),
                    ...
                    ListView.builder(
                        ...
                        itemBuilder: (context, index) {
                          if (categories[i]["value"] ==
                              sellers[index]["businesscatagories"]) {
                            count = count + 1;
                          }
                                                                ...
                                                                MaterialPageRoute(
                                                                    builder: (context) =>
                                                                        ProductDetailsScreen(
                                                                            sellers[index]["products"][iindex]["_id"].toString())));
                                                          },
                                                          child: SizedBox(
                                                            child: SizedBox(
                                                              height: 210,
                                                                    ...
                                                                    child:
                                                                      ...
                                                                      child:
                                                                        ...
                                                                        child: Image
                                                                            .network(
                                                                          baseUrl +
                                                                              sellers[index]["products"][iindex]["image"][0]["filename"],
                                                                          fit: BoxFit
                                                                              .cover,
                                                                        ),
                                                                      ),
