...
class PayFeaturedAdScreen extends StatefulWidget {
  final double amount;
  final String id;
  PayFeaturedAdScreen(this.amount, this.id);

  @override
  State<PayFeaturedAdScreen> createState() => _PayFeaturedAdScreenState();
}

class _PayFeaturedAdScreenState extends State<PayFeaturedAdScreen> {
