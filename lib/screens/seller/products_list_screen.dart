                                                        ...
                                                        InkWell(
                                                          onTap: () {
                                                            Navigator.push(
                                                                ...
                                                                MaterialPageRoute(
                                                                    builder: (context) =>
                                                                        ProductEditScreen(products[index]
                                                                            [
                                                                            "_id"])));
                                                          },
                                                          child: Stack(
                                                                  ...
                                                                  onSelected:
                                                                    ...
                                                                    if (newValue ==
                                                                      ...
                                                                      Navigator.push(
                                                                          context,
                                                                          MaterialPageRoute(
                                                                              builder: (context) => ProductEditScreen(products[index]["_id"])));
                                                                    }
                                                                  },
                                                                  itemBuilder:
                                                                      (context) =>
                                                                              ...
                                                                              onTap: () {
                                                                                showDialog(
                                                                                    ...
                                                                                    builder: (BuildContext context) => CupertinoAlertDialog(
                                                                                          ...
                                                                                          content: new Text("Do you want to delete '" + products[index]["productname"] + "' "),
                                                                                          actions: <Widget>[
                ...
                : Container(
                    ...
                    decoration: BoxDecoration(
                      image: DecorationImage(
                        image: AssetImage("images/emptyrack.jpg"),
                        fit: BoxFit.cover,
                      ),
                    ),
                    child: Column(
