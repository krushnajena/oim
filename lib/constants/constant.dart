...
const mapApiKey = "AIzaSyDpTVBkdj3DPO2u0K84_DkDsaE5mcW7A1c";

const fPrimaryColor = Color(0xFF4a4bf6);
const fTextColor = Color(0xFF757575);
const fAnimationDuration = Duration(milliseconds: 200);

const Color primaryColor = const Color(0xFF81c537);
const Color whiteColor = Colors.white;
const Color blackColor = Colors.black;
const Color greyColor = const Color(0xFF064a7b);
...
const Color primaryColor1 = Color(0xFF2e6da4);
...
const TextStyle greenBoldTextStyle = const TextStyle(
  fontSize: 14.0,
  color: primaryColor,
  fontWeight: FontWeight.bold,
);
const TextStyle blueBoldTextStyle = const TextStyle(
  fontSize: 14.0,
  color: primaryColor1,
  fontWeight: FontWeight.bold,
);
...
const TextStyle logoblue16BoldTextStyle = const TextStyle(
  fontSize: 16.0,
  color: primaryColor1,
  fontWeight: FontWeight.bold,
);
...
const TextStyle white17BoldTextStyle = const TextStyle(
  fontSize: 18.0,
  color: whiteColor,
  fontWeight: FontWeight.bold,
);
...
class AppConstants {
  ...
  static List<String> getYearMonths(intlDelegate) {
    return [
  ...
  static List<String> getWeekDays(intlDelegate) {
    return [
      intlDelegate.sunday,
      intlDelegate.monday,
